...
const SingleProduct = () => {
  ...
  const AddToCartHandle = (e) => {
    e.preventDefault();
    router.push(`/cart/${productId}?qty=${qty}&size=${sizes}`);
  };
                      ...
                      product.countInStock > 0 ? (
                        <>
                          <div className="flex-box d-flex justify-content-between align-items-center">
                            ...
                            >
                              {product.sizes?.map((keySize, x) => (
                                <option key={keySize} value={product.sizes[x]}>
                                  {product.sizes[x]}
                                </option>
                              ))}
                            </select>
                  ...
                  <form onSubmit={submitHandler}>
                    ...
                    <div className="my-4">
                      ...
                      <textarea
                        ...
                        className="col-12 bg-light border-0 p-3 rounded"
                      ></textarea>
                    </div>
                    <div className="my-3">
                      <button
                        disabled={loadingCreateReview}
                        className="col-12 bg-light border-0 p-3 rounded text-black"
                      >
                        SUBMIT
                      </button>
                    </div>
